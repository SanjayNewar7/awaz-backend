...
Route::get('/superadmin/notifications', [NotificationWebController::class, 'index'])->name('superadmin.notifications');
...
Route::post('/notifications', [NotificationWebController::class, 'store'])->name('notifications.store');
