...
@section('title', 'Awaz - SuperAdmin Dashboard')

@section('content')
    <header>
        <div class="logo">Dashboard Overview</div>
    ...
    <style>
        ...
        .logo {
            ...
            -webkit-background-image: linear-gradient(135deg, #ffffff, #ffffff);
        }
...
@section('scripts')
    <script>
        ...
        const renderUserDetails = (user) => {
            return `
                ...
                <div class="document-section">
                    ...
                    <div class="document-images">
                        ...
                        <div class="document-image-container">
                            <img src="${user.citizenship_front_image}" alt="Citizenship Front" class="document-image">
                            <div class="document-image-label">Front Side</div>
                        </div>
                        ` : ''}
                        ${user.citizenship_back_image ? `
                        <div class="document-image-container">
                            <img src="${user.citizenship_back_image}" alt="Citizenship Back" class="document-image">
                ...
                <div class="action-bar">
                    <button class="btn btn-success" onclick="toggleVerification(${user.user_id}, ${user.is_verified})">
                    ...
                    <button class="btn btn-danger" onclick="deleteUser(${user.user_id})">Delete Account</button>
                </div>
            `;
        };
        ...
        const fetchUsers = async () => {
            try {
                usersListBody.innerHTML = '<div class="loading">Loading dashboard data...</div>';
                ...
                usersListBody.innerHTML = `<div class="loading" style="color: var(--danger);">Error loading dashboard data: ${error.message}</div>`;
            }
        };
